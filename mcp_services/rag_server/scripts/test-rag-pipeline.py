...
# Find projektets rodmappe
script_dir = os.path.dirname(os.path.abspath(__file__))
project_root = os.path.abspath(os.path.join(script_dir, "../../../"))

# Læs konfiguration fra config.yaml hvis den findes
config = {
    "vector_search_url": "http://localhost:5021/search",  # Opdateret til ny port
...
try:
    import yaml
    config_path = os.path.join(project_root, "mcp_services", "rag_server", "config.yaml")
