...
-- CreateIndex
CREATE UNIQUE INDEX "UserProgress_quizAttemptId_key" ON "UserProgress"("quizAttemptId");

-- CreateIndex
CREATE UNIQUE INDEX "UserProgress_userId_lessonId_quizId_key" ON "UserProgress"("userId", "lessonId", "quizId");
