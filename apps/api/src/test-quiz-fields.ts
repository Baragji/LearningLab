...
async function testQuizFields() {
  ...
  try {
    ...
    if (!module) {
      console.log('No modules found to test with. Please create a module first.');
      return;
    }
    ...
    const quiz = await prisma.quiz.create({
      data: {
        ...
        description: 'Testing timeLimit, maxAttempts, randomizeQuestions, and showAnswers fields',
        moduleId: module.id,
