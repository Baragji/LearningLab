...
const QuizNavigation: React.FC<QuizNavigationProps> = ({
  ...
  }, [currentQuestionIndex, isFirstQuestion, isLastQuestion, allQuestionsAnswered, isSubmitting, onPrevious, onNext]);
      ...
      >
        ...
        >
          {isLastQuestion ? (
            ...
            allQuestionsAnswered ? 'Finish Quiz' : 'Complete All Questions'
          ) : 'Next'}
        </Button>
      </Stack>
