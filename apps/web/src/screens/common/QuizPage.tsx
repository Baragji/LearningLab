  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      setQuizResults({
        ...
        correctAnswers: results.score ? Math.round((results.score / 100) * questions.length) : 0
      });
      setShowResults(true);
    } catch (error) {
        ...
        {currentQuestion && (
          <Box sx={{ mt: 4 }}>
            <QuizQuestion
              ...
              correctAnswerId={isReviewMode ? answerOptions[currentQuestion.id]?.find(option => option.isCorrect)?.id : undefined}
            />
          </Box>
        )}
      ...
      >
        ...
        <DialogContent>
          <Typography variant="body1" paragraph>
            Are you ready to submit your quiz? Please review your progress below:
          </Typography>
          ...
          <Card sx={{ mb: 3 }}>
            <CardContent>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={4}>
                  <Box sx={{ textAlign: 'center' }}>
                    <Typography variant="h4" color={unansweredQuestions > 0 ? 'warning.main' : 'success.main'}>
                      {unansweredQuestions}
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                      Unanswered
