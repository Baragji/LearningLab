        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Find det perfekte kursus til din læring. Browse gennem vores udvalg af kurser og tilmeld dig dem, der interesserer dig.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {error && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">Der opstod en fejl ved indlæsning af kurser.</p>
            <button
              onClick={() => refetch()}
        ...
        {!isLoading && !error && allCourses.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Ingen kurser fundet</h3>
            <p className="text-gray-600">
              {searchTerm || selectedLevel
