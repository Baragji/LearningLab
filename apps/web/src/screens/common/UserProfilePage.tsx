...
const UserProfilePage: React.FC = () => {
  ...
  const { data: userCoursesData, isLoading: coursesLoading } = useGetUserCoursesQuery();
  const { data: userStats, isLoading: statsLoading } = useGetUserStatisticsQuery();
      ...
      <Paper elevation={2} sx={{ p: 4 }}>
                ...
                <Grid item xs={12}>
                  <Paper sx={{ p: 4, textAlign: 'center' }}>
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                      Du har ikke tilmeldt dig nogen kurser endnu. Udforsk vores kurser for at komme i gang!
                    </Typography>
                ...
                <Grid item xs={12} sm={4}>
                  <Card>
                    <CardContent sx={{ textAlign: 'center' }}>
                      ...
                      <Typography variant="h4" component="div">
                        {userCoursesData?.courses?.filter(course => 
                ...
                <List>
                  {userStats.quizResults.slice(0, 5).map((result, index) => (
                    <ListItem key={index} divider>
                      ...
                      />
                      <Typography variant="body2" color="text.secondary">
                        {new Date(result.completedAt).toLocaleDateString('da-DK')}
                      </Typography>
                    </ListItem>
                  ))}
                </List>
        ...
        <TabPanel value={tabValue} index={4}>
          ...
          <Typography variant="body1" color="textSecondary">
            Indstillinger funktionalitet er under udvikling. Her kan brugeren ændre notifikations- og
            privatindstillinger.
          </Typography>
        </TabPanel>
      </Paper>
