...
test.describe("Brugerregistrering", () => {
  ...
  test("skal tillade indtastning af registreringsoplysninger", async ({
    page,
  }) => {
    // Naviger til registreringssiden
    await page.goto("/signup");
  ...
  test("skal vise valideringsfejl ved ikke-matchende adgangskoder", async ({
    page,
  }) => {
    // Naviger til registreringssiden
    await page.goto("/signup");
    ...
    await expect(page.locator(".text-red-700")).toHaveText(
  ...
  test("skal gennemføre registreringsprocessen med succes", async ({
    page,
  }) => {
    // Naviger til registreringssiden
    await page.goto("/signup");
    ...
    await expect(page.locator(".text-green-700")).toHaveText(
