  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Oplev fremtidens læring med AI-drevet personalisering og moderne design"
        />
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center">
            ...
            {/* Subtitle */}
            <p
              className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto opacity-0 animate-fadeInDown"
              style={{ animationDelay: "0.2s" }}
            >
              Oplev personaliseret læring med AI-drevet teknologi, moderne
              design og engagerende gamification
            </p>

            {/* CTA Buttons */}
            <div
              className="flex flex-col sm:flex-row gap-4 justify-center mb-16 opacity-0 animate-fadeInDown"
              ...
              {[
                {
                  ...
                  description:
                    "Personaliserede læringsforløb tilpasset din læringsstil og tempo",
                },
                {
                  icon: (
                    <svg
                  ...
                  description:
                    "Engagerende quizzer med øjeblikkelig feedback og adaptive sværhedsgrad",
                },
                {
                  icon: (
                    <svg
                  ...
                  title: "Gamification",
                  description:
                    "Optjen XP, badges og konkurrér med andre i en motiverende læringsoplevelse",
                },
              ].map((feature, index) => (
                <div
                  key={index}
