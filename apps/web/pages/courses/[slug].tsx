...
const CourseDetail: React.FC = () => {
  ...
  if (moduleId1)
    lessonsData[moduleId1] = {
      data: result1.data || [],
      isLoading: result1.isLoading,
    };
  if (moduleId2)
    lessonsData[moduleId2] = {
      data: result2.data || [],
      isLoading: result2.isLoading,
    };
  if (moduleId3)
    lessonsData[moduleId3] = {
      data: result3.data || [],
      isLoading: result3.isLoading,
    };
  if (moduleId4)
    lessonsData[moduleId4] = {
      data: result4.data || [],
      isLoading: result4.isLoading,
    };
                        ...
                        {!module.isLoadingLessons &&
                          module.lessons.map((lesson) => (
                            ...
                            >
                              <div className="flex items-center">
                                <svg
                                  className="h-5 w-5 mr-3 text-gray-400 dark:text-gray-500"
                                  fill="none"
                                  viewBox="0 0 24 24"
                                  stroke="currentColor"
                                >
